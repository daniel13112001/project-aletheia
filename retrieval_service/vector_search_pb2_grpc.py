...
class VectorSearchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Search = channel.unary_unary(
                '/vectorsearch.VectorSearchService/Search',
...
def add_VectorSearchServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'vectorsearch.VectorSearchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('vectorsearch.VectorSearchService', rpc_method_handlers)
